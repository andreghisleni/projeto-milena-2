...
export default function EditMusic() {
  ...
  const saveData = async () => {
    try {
      ...
      const noteRef = ref(database, `musics/${params.id}`);
      ...
      console.log('Registro Editado com Sucesso! ' + params.id);
  ...
  return (
    <ParallaxScrollView className="bg-[#6d2ffa] pt-8">
      ...
      <Button size="md" variant="outline" action="positive" onPress={saveData}>
